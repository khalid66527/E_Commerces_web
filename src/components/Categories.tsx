  ...
  return (
    <div className="py-6">
      ...
      <div className="text-center mb-16">
        <h1 className="text-4xl md:text-5xl font-black tracking-widest text-white uppercase">
      ...
      {categories.length === 0 ? (
        <div className="text-center py-20 bg-white/[0.02] border border-white/[0.05] rounded-3xl backdrop-blur-md">
          ...
          <p className="text-gray-400 mt-4 text-lg">No categories found in the database yet.</p>
        </div>
      ) : (
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {categories.map((cat, idx) => (
            ...
            >
              ...
              {/* Inner container */}
              <div className="relative z-10 w-full h-80 bg-[#080812] rounded-[22px] overflow-hidden flex flex-col justify-between p-8 border border-white/[0.04] group-hover:border-transparent transition-all duration-300">
                ...
                <div className="absolute inset-0 z-0">
                  ...
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-[#080812] via-[#080812]/90 to-[#080812]/20" />
                </div>

                {/* Content layers */}
                <div className="relative z-10 flex justify-between items-start gap-4">
                  {/* Icon wrapper */}
                  <div className="p-4 bg-white/[0.03] border border-white/[0.06] rounded-2xl group-hover:scale-110 group-hover:bg-[#8B5CF6]/10 group-hover:border-[#8B5CF6]/30 transition-all duration-500 shadow-md">
                    {getCategoryIcon(cat.name)}
                  </div>
                  
                  {/* Count badge */}
                  <span className="px-3.5 py-1.5 bg-[#080812]/80 border border-white/[0.08] rounded-full text-xs font-black text-[#EC4899] group-hover:bg-[#EC4899]/10 group-hover:border-[#EC4899]/30 transition-all duration-300 shadow-lg">
                ...
                <div className="relative z-10 space-y-3">
                  <h3 className="text-2xl font-black text-white group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-gradient-to-r group-hover:from-white group-hover:to-gray-300 transition-all duration-300 tracking-wide uppercase">
                    {cat.name}
                  </h3>
